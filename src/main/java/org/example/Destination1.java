...
public class Destination1 {
    private static final int RECEIVE_PORT = 2345;
    ...
    public static void main(String[] args) throws IOException {
        ...
        for (int i = 0; i < Sender.NUM_PACKETS; i++) {
            ...
            DatagramPacket sendPacket = new DatagramPacket(buffer, buffer.length, InetAddress.getByName("localhost"), Destination2.RECEIVE_PORT);
